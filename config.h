...
static char *fonts[] = {"Monaspace Argon:size=12", "waffle:size=10;3"};
...
static const Rule rules[] = {
    ...
    /* ... other rules ... */
    {TERMCLASS, "neovim", NULL, 0, 0,
     0}, // Replace "Neovim" with the actual WM_CLASS of Neovim
    {TERMCLASS, "nvim", NULL, 0, 0,
     0}, // Replace "Neovim" with the actual WM_CLASS of Neovim
};
...
static Key keys[] = {
    ...
    {MODKEY | ShiftMask, XK_equal, spawn,
     SHCMD("wpctl set-volume @DEFAULT_AUDIO_SINK@ 15%+; kill -44 $(pidof "
           "dwmblocks)")},
    //{ MODKEY,			XK_BackSpace,	spawn,		{.v = (const
    //char*[]){ "sysact", NULL } } },
    ...
    //(const char*[]){ TERMINAL, "-e", "sudo", "nmtui", NULL } } }, { MODKEY,
    //XK_e,		spawn,		SHCMD(TERMINAL " -e neomutt ; pkill
    //-RTMIN+12 dwmblocks; rmdir ~/.abook") }, { MODKEY|ShiftMask,
    //XK_e,		spawn,		SHCMD(TERMINAL " -e abook -C
    //~/.config/abook/abookrc --datafile ~/.config/abook/addressbook") }, {
    //MODKEY,			XK_r,		spawn,		{.v = (const
    //char*[]){ TERMINAL, "-e", "lfub", NULL } } },
    {MODKEY | ShiftMask,
     XK_r,
     spawn,
    ...
    // &layouts[4]} }, /* deck */ { MODKEY|ShiftMask,		XK_u,
    // setlayout,	{.v = &layouts[5]} }, /* monocle */ { MODKEY,
    // XK_i,		setlayout,	{.v = &layouts[6]} }, /* centeredmaster
    // */ { MODKEY|ShiftMask,		XK_i,		setlayout,	{.v =
    // &layouts[7]} }, /* centeredfloatingmaster */
    ...
    {MODKEY, XK_period, togglegaps, {0}},
    {MODKEY | ShiftMask, XK_period, defaultgaps, {0}},
    {MODKEY, XK_s, togglesticky, {0}},
    //{ MODKEY,			XK_d,		spawn,          {.v = (const
    //char*[]){ "dmenu_run", NULL } } }, { MODKEY|ShiftMask,		XK_d,
    //spawn,		{.v = (const char*[]){ "passmenu", NULL } } },
    ...
    {MODKEY | ShiftMask, XK_Delete, togglescratch, {.ui = 0}},
    ...
    //char*[]){ TERMINAL, "-e", "profanity", NULL } } },
    ...
    /* { MODKEY|ShiftMask,		XK_b,		spawn,
       SHCMD("") }, */
    //{ MODKEY,			XK_n,		spawn,		{.v = (const
    //char*[]){ TERMINAL, "-e", "nvim", "-c", "VimwikiIndex", NULL } } }, {
    //MODKEY|ShiftMask,		XK_n,		spawn,		SHCMD(TERMINAL "
    //-e newsboat ; pkill -RTMIN+6 dwmblocks") }, { MODKEY,
    //XK_m,		spawn,		{.v = (const char*[]){ TERMINAL, "-e",
    //"ncmpcpp", NULL } } },
    ...
    //{ MODKEY,			XK_period,	spawn,		{.v = (const
    //char*[]){ "mpc", "next", NULL } } }, { MODKEY|ShiftMask,
    ...
    /* { MODKEY|ShiftMask,		XK_Page_Up,	shifttag,	{ .i =
       -1 } }, */
    /* { MODKEY,			XK_Page_Down,	shiftview,	{ .i =
       +1 } }, */
    ...
    /*
       ...
       (const char*[]){ "tutorialvids", NULL } } }, { MODKEY,
       XK_F3,		spawn,		{.v = (const char*[]){ "displayselect",
       NULL } } }, { MODKEY,			XK_F4,		spawn,
       SHCMD(TERMINAL " -e pulsemixer; kill -44 $(pidof dwmblocks)") }, {
       MODKEY,			XK_F5,		xrdb,		{.v = NULL } },
        { MODKEY,			XK_F6,		spawn,		{.v =
       (const char*[]){ "torwrap", NULL } } }, { MODKEY,
       XK_F7,		spawn,		{.v = (const char*[]){ "td-toggle", NULL
       } } }, { MODKEY,			XK_F8,		spawn,		{.v =
       (const char*[]){ "mw", "-Y", NULL } } }, { MODKEY,
       XK_F9,		spawn,		{.v = (const char*[]){ "dmenumount",
       NULL } } }, { MODKEY,			XK_F10,		spawn,
       {.v = (const char*[]){ "dmenuumount", NULL } } }, { MODKEY,
       XK_F11,		spawn,		SHCMD("mpv --untimed --no-cache --no-osc
       --no-input-default-bindings --profile=low-latency --input-conf=/dev/null
       --title=webcam $(ls /dev/video[0,2,4,6,8] | tail -n 1)") }, { MODKEY,
    ...
    */
    ...
    //{ MODKEY,			XK_Delete,	spawn,		{.v = (const
    //char*[]){ "dmenurecord", "kill", NULL } } },
